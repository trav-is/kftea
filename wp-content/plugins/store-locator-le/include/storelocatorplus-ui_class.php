...
class SLPlus_UI {
    ...
    function create_DefaultMap() {
        ...
        //
        $content =
            '<div class="map-results"><div class="ten columns alpha">'. 
    ...
    function create_Results() {
        $HTML =  
            "<div class='six columns omega'><table id='results_table'>".
    ...
    function localizeCSLScript() {
        ...
        $scriptData = array(
            ...
            'label_hours'       => esc_attr(get_option(SLPLUS_PREFIX.'_label_hours',        '')       ),
            'label_phone'       => esc_attr(get_option(SLPLUS_PREFIX.'_label_phone',        'TEL: ')       ),
    ...
    function setResultsString() {
        if ($this->resultsString === '') {
            $this->resultsString =
                '<div id="slp_results_table_{15}">'  .
                	'<div id="slp_location_{15}">'  .       
